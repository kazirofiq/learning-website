            ...
            <div className='lg:px-[145px]' >
                <nav className="bg-[#ECECF5] rounded-[10px] mt-[32px] lg:block hidden lg:w-[77%]">
                    <ul className="flex justify-between h-[37px] items-center">
                        <li className=''>
                            <Link className={activeItem === 'aboutTheCourse' ? 'active bg-[#3D419F] rounded-[10px] text-[#FFFFFF] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center' : 'bg-[#ECECF5] rounded-[10px] text-[#333] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center'} onClick={() => handleItemClick('aboutTheCourse')}>
                                <a href="#aboutTheCourse">Details</a>
                            </Link>
                        </li>
                        <li>
                            <Link className={activeItem === 'WhatWillYouLearn' ? 'active bg-[#3D419F] rounded-[10px] text-[#FFFFFF] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center' : 'bg-[#ECECF5] rounded-[10px] text-[#333] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center'} onClick={() => handleItemClick('WhatWillYouLearn')}>
                                <a href="#WhatWillYouLearn">What You Learn</a>
                            </Link>
                        </li>
                        <li>
                            <Link className={activeItem === 'PricingCategory' ? 'active bg-[#3D419F] rounded-[10px] text-[#FFFFFF] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center' : 'bg-[#ECECF5] rounded-[10px] text-[#333] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center'} onClick={() => handleItemClick('PricingCategory')}>
                                <a href="#PricingCategory">Pricing Plan</a>
                            </Link>
                        </li>
                        <li>
                            <Link className={activeItem === 'frequentlyAskedQuestion' ? 'active bg-[#3D419F] rounded-[10px] text-[#FFFFFF] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center' : 'bg-[#ECECF5] rounded-[10px] text-[#333] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center'} onClick={() => handleItemClick('frequentlyAskedQuestion')}>
                                <a href="#frequentlyAskedQuestion">FAQ</a>
                            </Link>
                        </li>
                        <li>
                            <Link className={activeItem === 'LearnerReview' ? 'active bg-[#3D419F] rounded-[10px] text-[#FFFFFF] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center' : 'bg-[#ECECF5] rounded-[10px] text-[#333] h-[37px] flex items-center w-[97px] lg:w-[140px] justify-center'} onClick={() => handleItemClick('LearnerReview')}>
