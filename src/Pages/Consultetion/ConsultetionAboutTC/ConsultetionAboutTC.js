    ...
    return (
        <div className='px-[20px] lg:px-[145px]'>
            <div id="aboutTheCourse" className='mx-auto'>
                <h3 className='font-bold text-2xl text-[#1B1D48] pt-[30px] text-center'>What Will You Learn?</h3>
                <div className='grid mx-auto grid-cols-1 lg:grid-cols-2 gap-[30px] pt-[10px]'>
                    <div className='poppins mx-auto max-w-[540px]' id='aboutTheCourse'>
