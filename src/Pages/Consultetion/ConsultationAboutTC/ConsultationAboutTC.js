            ...
            <div id="aboutTheCourse" className='mx-auto'>
                ...
                <div className='grid mx-auto grid-cols-1 lg:grid-cols-2 gap-[30px] pt-[10px] text-left'>
                    ...
                    <div className='poppins  max-w-[540px]' id='aboutTheCourse'>
                        <p className='font-normal text-sm lg:text-base leading-6 text-[#666666] mt-2 lg:mt-4'> Whether you're a budding freelancer or an aspiring creative professional, my consultations are designed to provide you with invaluable advice, practical tips, and industry expertise to help you succeed in your freelancing endeavors. Join me at Learn With Rakib and let's unlock your creative potential together!</p>
                    </div>
                </div>
            </div>
        </div>
