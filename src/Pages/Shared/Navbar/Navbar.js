...
>>>>>>> 46d61f45b07c97a502255af5f3136e0774cb8368
    ...
    const menuItems = (
        <>
            <li tabIndex={0} className="relative">
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                    <summary
                        className="flex cursor-pointer items-center lg:justify-between rounded-lg  lg:py-2 text-gray-500 hover:text-gray-700"
                    >
...
<<<<<<< HEAD
  return (
    <section className="bg-[#FFFFFF]">
      <div className="max-w-[1350px] block lg:px-11 mx-auto pt-11 pb-9 ">
