        ...
        <>
            <li tabIndex={0}>
                ...
                <ul className="p-2 border">
                    <li className='border '><Link to='/premium_course'><GiQueenCrown></GiQueenCrown>Premium Course</Link></li>
        ...
        <div className='bg-[#FAF7F5] bg-opacity-90 bg-transparent border-b-2'>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link className="normal-case text-xl" to={'/'}><img className='w-36' src={logo} alt="" /></Link>
                </div>
