...
import Md_Nishat from '../../../assest/studet_feedback/Md_Nishat.jpeg';
                ...
                <Slider className='max-w-[92%] mx-auto' {...settings}>
                    {
                        students.map(student =>
                            <div key={student.id} className='relative h-[203px] border-[#3D419F] rounded-xl text-center sumu border-y-[1px]'>
                                <img className='absolute top-[-18%] right-[43%] h-14 w-14 rounded-full border-2 border-[#3D419F]' src={student.image} alt='' />
