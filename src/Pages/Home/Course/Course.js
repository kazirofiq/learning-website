...
const Course = () => {
  return (
    <section
      className="mt-32 mb-[100px] px-5 lg:px-0"
      style={{
            ...
            <div className="card hover:bg-[#3D419F] hover:text-white shadow-xl">
              ...
              <div className="card-body items-center text-center">
                ...
                <div className=" flex justify-center items-center gap-2">
                  <h2 className="text-[16px] font-bold hover:text-[#FFFFFF] cursor-pointer">
                    Learn More
                  </h2>
          ...
          <div className="">
            <div className="card bg-[#FFFFFF] hover:bg-[#3D419F] hover:text-white shadow-xl">
              ...
              <div className="card-body items-center  text-center">
                ...
                <div className=" flex justify-center items-center gap-2">
                  <h2 className="text-[16px] font-bold  hover:text-white cursor-pointer">
                    Learn More
                  </h2>
                  <IoIosArrowForward className=""></IoIosArrowForward>
                </div>
