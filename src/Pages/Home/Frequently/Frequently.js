...
const Frequently = () => {
  return (
    <div className="mt-[86px] bg-[#F7F7FE] lg:h-[800px]">
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2  lg:gap-[30px] md:gap-[30px] lg:h-[686px]  lg:px-[145px] md:px-[145px]">
        <div className="text-start lg:w-[540px] md:w-[540px] ">
          <section className="dark:text-gray-100   ">
            <div className="container justify-between flex flex-col   py-8  md:p-8">
              <div className="space-y-4 lg:w-[540px] md:w-[540px] w-[328px] ">
                <div
                  tabIndex={0}
        ...
        <div className="">
          <img className="hidden lg:block mr-0 w-[477px]" src={thinginglg} alt="" />
      ...
      >
        <div class="">
          <div class=" md:mx-[145px]  max-w-xl text-center sm:text-left">
            <div className="text-start ml-7 md:ml-0 lg:w-[540px] md:w-[540px] ">
              <section className="dark:text-gray-100   ">
                <div className="container justify-between flex flex-col   py-8  md:p-8">
                  <div className="space-y-4 lg:w-[540px] md:w-[540px] w-[328px] ">
                    <div
        ...
        <div className="md:ml-[5.5rem]">
          <img className="w-[470px] " src={thinkimg} alt="" />
        </div>
      </section>
