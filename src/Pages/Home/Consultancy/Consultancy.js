                ...
                <div className="hero lg:pl-44">
                    <div className="hero-content flex-col lg:flex-row-reverse gap-x-32">
                        <div className='lg:text-left text-center'>
                            ...
                            <p className="mt-3 lg:mt-6 md:mt-6 text-sm lg:text-base md:text-base text-[#666666]">Expert guidance for designers to jumpstart their careers and expand their work. Personalized consultations to identify strengths, set goals, and develop strategies. </p>
