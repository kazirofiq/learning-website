            ...
            <div className="hero lg:pl-44 max-w-[1350px] lg:pb-[87px] lg:pt-[13px]">
                <div className="hero-content flex-col lg:flex-row-reverse gap-x-32">
                    <div className='lg:text-left text-center'>
                        ...
                        <button className="mt-6 lg:mt-10 md:mt-10 px-4 py-2 lg:px-8 lg:py-4 bg-[#3D419F] text-white rounded-xl lg:font-semibold font-normal lg:text-base text-sm">See Details</button>
                    </div>
