        ...
        <section className='bg-[#F8F8FF]'>
            <div className=' md:mx-[145px]  flex-row-reverse justify-between lg-w-full lg:flex md:flex pt-5 lg:pt-0 pb-[40px] lg:pb-[90px] items-center'>
                ...
                <div className='flex-row lg:mr-[31px]'>
                    ...
                    <p className='text-[#666666] leading-6 text-[16px] mb-11 lg:text-left md:text-left text-center'>Learn With Rakib is an interesting platform that will teach you in <span>more an interactive way</span> </p>
