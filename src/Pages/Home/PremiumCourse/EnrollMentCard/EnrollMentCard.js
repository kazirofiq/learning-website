...
const EnrollMentCard = () => {
    return (
        <div className='mt-[-200px]'>
            <div className="card poppins w-[350px] bg-base-100 shadow-xl static top-0 inline-block">
                <div className='relative cursor-pointer'>
                <figure>
                <img src={videoImg} alt="video" />
                   <div className='absolute flex justify-center items-center'>
                    <img  className='mr-4' src={videoPlayIcon} alt="" />
                    <h4 className='text-2xl text-[#FFFFFF] font-bold leading-[36px]'>Preview</h4>
                   </div>
                </figure>
                </div>
            ...
            <div className="card-body p-[25px]">
               ...
               <div className="alert alert- h-11 rounded-none bg-[#FFFFFF] border-b-[1px] border-[#E6E6E6] flex justify-between">
                <div className='flex items-center'>
                    ...
                    <span className='font-normal text-base text-[#333333]'>Instructor</span>
                </div>
                <h4 className='font-normal text-base text-[#333333]'>Rasel Mondol</h4>
        </div>
        <div className="alert alert- h-11 rounded-none bg-[#FFFFFF] border-b-[1px] border-[#E6E6E6] flex justify-between">
                <div className='flex items-center'>
                    <img className='h-5 w-[22px]' src={time} alt="" />
                    <span className='font-normal text-base text-[#333333]'>Duration</span>
                </div>
                <h4 className='font-normal text-base text-[#333333]'>3 Month</h4>
        </div>
        <div className="alert alert- h-11 rounded-none bg-[#FFFFFF] border-b-[1px] border-[#E6E6E6] flex justify-between">
                <div className='flex items-center'>
                    <img className='h-5 w-[22px]' src={lesson} alt="" />
                    <span className='font-normal text-base text-[#333333]'>Lesson</span>
                </div>
                <h4 className='font-normal text-base text-[#333333]'>24</h4>
        </div>
        <div className="alert alert- rounded-none h-11 bg-[#FFFFFF] border-b-[1px] border-[#E6E6E6] flex justify-between">
                <div className='flex items-center'>
                    ...
                    <span className='font-normal text-base text-[#333333]'>Enrolled</span>
                </div>
                <h4 className='font-normal text-base text-[#333333]'>35 Student</h4>
        </div>
        <div className="alert alert- rounded-none h-11 bg-[#FFFFFF] border-b-[1px] border-[#E6E6E6] flex justify-between">
                <div className='flex items-center'>
                <img className='h-5 w-[22px]' src={group} alt="" />
                    <span className='font-normal text-base text-[#333333]'>Course Level</span>
                </div>
                <h4 className='font-normal text-base text-[#333333]'>Intermediate</h4>
        </div>
        <div className="alert alert- rounded-none h-11 bg-[#FFFFFF] flex justify-between">
                <div className='flex items-center'>
                    <img className='h-5 w-[22px]' src={access} alt="" />
                    <span className='font-normal text-base text-[#333333]'>Access</span>
                </div>
                <h4 className='font-normal text-base text-[#333333]'>Life Time</h4>
        </div>
               </div>
               {/* pricing section */}
               <div className='flex justify-between items-center mt-[46px] px-[32px]'>
                ...
                <div className="card-actions justify-center items-center w-full mt-[30px]">
                <button className="rounded-[10px] text-base font-[600] text-[#FFFFFF] bg-[#3D419F] py-[10px] w-full">Enroll Now</button>
                </div>
            </div>
            </div>
        </div>
