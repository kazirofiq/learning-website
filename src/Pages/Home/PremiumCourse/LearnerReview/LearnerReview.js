...
const LearnerReview = () => {
    return (
        <section className='max-w-[1110px] mx-auto zi' id='learnerReview'>
            ...
            <div className='block lg:flex gap-0 lg:gap-[58px] w-[320px] lg:w-[730px] poppins mt-0 lg:mt-6 mb-4 lg:mb-6 rounded-2xl custom_shadow mx-auto lg:mx-0'>
                ...
                <div className='w-[320px] lg:w-[430px] grid content-center'>
                    <div className='flex items-center mb-3 text-[#333333] lg:mb-[15px] text-sm lg:text-base leading-[21px] lg:leading-6 poppins'>
                        ...
                        <progress className="progress progress-red-200 bg-[#C3C4E1] w-[170px] lg:w-[264px] h-[6px] lg:h-[10px] -z-50" value="70" max="100"></progress>
                        <p className='pl-[5px] lg:pl-[10px]'>70%</p>
                    </div>
                    <div className='flex items-center mb-3 text-[#333333] lg:mb-[15px] text-sm lg:text-base leading-[21px] lg:leading-6 poppins'>
                        <p className='mr-3 lg:mr-[22px] w-[101px] lg:w-[84px] '>Very Good</p>
                        <progress className="progress progress-red-200 bg-[#C3C4E1] w-[170px] lg:w-[264px] h-[5.5px] lg:h-[10px] -z-50" value="20" max="100"></progress>
                        <p className='pl-[5px] lg:pl-[10px]'>20%</p>
                    </div>
                    <div className='flex items-center mb-3 text-[#333333] lg:mb-[15px] text-sm lg:text-base leading-[21px] lg:leading-6 poppins'>
                        <p className='mr-3 lg:mr-[22px] w-[101px] lg:w-[84px] '>Average</p>
                        <progress className="progress progress-red-200 bg-[#C3C4E1] w-[170px] lg:w-[264px] h-[5.5px] lg:h-[10px] -z-50" value="30" max="100"></progress>
                        <p className='pl-[5px] lg:pl-[10px]'>30%</p>
                    </div>
                    <div className='flex items-center mb-3 text-[#333333] lg:mb-[15px] text-sm lg:text-base leading-[21px] lg:leading-6 poppins'>
                        <p className='mr-3 lg:mr-[22px] w-[101px] lg:w-[84px] '>Poor</p>
                        <progress className="progress progress-red-200 bg-[#C3C4E1] w-[170px] lg:w-[264px] h-[6px] lg:h-[10px] -z-50" value="2" max="100"></progress>
                    ...
                    <div className='flex items-center mb-3 text-[#333333] text-sm lg:text-base leading-[21px] lg:leading-6 poppins'>
                        ...
                        <progress className="progress progress-red-200 bg-[#C3C4E1] w-[170px] lg:w-[264px] h-[6px] lg:h-[10px] -z-50" value="0" max="100"></progress>
