...
const SignIn = () => {
  ...
  return (
    ...
    >
      ...
      {/* <div className="hero lg:w-[398px] lg:h-[372px]     mb-[44px]  mx-auto text-black">
                <div className="hero-content flex-col justify-center items-center lg:flex-row p-0  mt-5 md:mt-10 mb-10 md:mb-16">
