            ...
            <div className='flex items-center justify-between'>
                ...
                <li>
                    <div className="dropdown dropdown-bottom border px-[10px] lg:px-[24px] md:px-5 py-[12px] lg:py-5 md:py-4 rounded-xl">
                        ...
                        >
                            <span className="text-[#333333] capitalize font-medium text-sm leading-[21px]">
                                Highest Rated
                            </span>{" "}
                        ...
                        >
                            <li>
                                <Link to='' className='text-[#333333] hover:bg-[#ECECF5] h-[36px] py-2 px-6'>Most Recent </Link>
                            </li>
                            <li>
                                <Link to='' className='text-[#333333] hover:bg-[#ECECF5] rounded-t-[12px] h-[36px] py-2 px-6'>Highest Rated</Link>
                            </li>
                            <li>
                                <Link to='' className='text-[#333333] hover:bg-[#ECECF5] rounded-t-[12px] h-[36px] py-2 px-6'>Lowest Rated</Link>
                            </li>
                        </ul>
                    </div>
                </li>
