  ...
  return (
    <section className=" bg-[#F8F8FF]">
      ...
      <div className="md:w-[844px] mx-auto  ">
       <hr class="dashed-line ml-8  mr-10 " />  
       <div className="flex justify-between -mt-4 px-4 mb-11">
          <div className="flex-col md:w-100 justify-center  items-center">
            <div className="bg-[#1B1D48] text-white text-center rounded-full h-7 w-7 ml-1">1</div>
            <h5 className="text-[#1B1D48] font-semibold">Login</h5>
          </div>
          <div className="flex-col justify-center  items-center">
            <div className="bg-[#1B1D48] text-white text-center rounded-full h-7 w-7 ml-7">2</div>
            <h5 className="text-[#1B1D48] font-semibold">Select Course</h5>
          </div>
          <div className="flex-col justify-center  items-center">
            <div className="bg-[#CACACA] text-white text-center rounded-full h-7 w-7 ml-4">3</div>
        ...
        <h2 className="text-[2rem] text-[#333333] font-bold mx-6 md:mx-0">Order Details</h2>
        <div>
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-5 ">
            ...
            <div className="bg-white rounded-lg p-8 mx-6 md:mx-0">
              <h2 className="text-[#1B1D48] font-bold text-xl pb-4 ">Payment Method</h2>
              ...
              <h5 className="text-[#1B1D48] font-bold text-xl pt-4 pb-3">Coupon</h5>
              ...
              <div className="form-control h-20 flex-row justify-start items-center shadow rounded-xl p-6 mb-5">
                <label className="label cursor-pointer pr-6 ">
                  <input type="radio" name="radio-10" className="radio checked:bg-[#1B1D48]"  />
              ...
              <div>
                <button className=" w-full bg-[#3D419F] rounded-xl text-white py-3 font-semibold "> Payment Complete</button>
              </div>
