...
const UploadResourseDropCard = () => {
    ...
    <div className="card w-96 bg-base-100 shadow-md pr-4 pl-[10px] py-[10px]">
     ...
     <div className='flex items-center'>
      ...
      <p className='mt-[2px] text-[#E8291D] font-light text-xs'>Graphic Design Bootcamp.Mp4</p>
      <p className='text-base font-normal text-[#E8291D]'>Try again</p>
      </div>
      </div>
...
<div>
    <div className="card w-96 bg-base-100 shadow-md pr-4 pl-[10px] py-[10px] mt-4">
       ...
       <div className='rounded-xl mt-3'>
            <div className="flex items-center">
        <img className='w-[26px] h-[26px] mr-[5px]' src={imgIcon} alt="" />
        <div className='flex items-center justify-between w-full'>
            <p className='text-[#333333] font-normal text-base'>Kdp Interior Book Cover.Jpg</p>
            <img src={checkedIcon} alt="" />
        </div>
</div>
<div className='flex flex-col ml-[31px]'>
<span className='text-[#666666] font-light text-xs'>5 MB</span>
<div className='flex items-center'>
<progress className="progress w-[410px] bg-[#E1F1EB] mr-3 progress-secondary" value="100" max="100"></progress>
<span className='text-[#333333] font-normal text-base'>100%</span>
        ...
        <div className='my-8'>
        <Buttons setRoute={'/admindashboard/course-create/faq'} text={'Publish'} />
        </div>
        </div>
    );
};
