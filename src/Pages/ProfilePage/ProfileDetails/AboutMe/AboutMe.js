                        ...
                        <div className='flex justify-end'>
                            ...
                            >
                                {items.map((item) => (
                                    <li
                                        key={item}
                                        class={`${selectedItem === item ? "font-medium text-[#1B1D48] text-base pl-4" : "font-medium text-[#1B1D48] text-base pl-4"
                                            } cursor-pointer select-none relative`}
                                        onClick={() => handleItemClick(item)}
                                    >
                                        <div class="flex items-center">
                                            <span
                                                class={`${selectedItem === item ? "font-semibold" : "font-normal"
                                                    } block truncate`}
                                            >
                                                {item}
                                            </span>
