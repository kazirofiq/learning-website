            ...
            <div>
                <div className='px-4 lg:px-8 md:px-7 py-6 lg:py-8 md:py-7 w-full lg:w-[540px] md:w-full border bg-[#FFFFFF] rounded-xl shadow-[#E7E7FF] shadow-xl mt-8 lg:mt-0 md:mt-0'>
                    ...
                    <div className='flex items-center justify-between mt-4'>
                        <p className='lg:leading-6 md:leading-6 leading-[21px] md:text-base lg:text-base text-sm font-normal text-[#333333]'>Book Type</p>
                    ...
                    <div className='flex items-center justify-between mt-4'>
                        <p className='lg:leading-6 md:leading-6 leading-[21px] md:text-base lg:text-base text-sm font-normal text-[#333333]'>Interior Type </p>
                        <select className="text-[#333333] select select-bordered w-[152px] lg:w-[298px] md:w-[200px]">
                    ...
                    <div className='flex items-center justify-between mt-7'>
                        <p className='lg:leading-6 md:leading-6 leading-[21px] md:text-base lg:text-base text-sm font-normal text-[#333333]'>Page Count</p>
                        <input type="number" placeholder="Type here" className="rounded-lg input input-bordered w-[152px] lg:w-[298px] md:w-[200px]" />
                    </div>
                    <div className='flex items-center justify-between mt-7'>
                        <p className='lg:leading-6 md:leading-6 leading-[21px] md:text-base lg:text-base text-sm font-normal text-[#333333]'>List Price</p>
                        <input type="number" placeholder="Type here" className="rounded-lg input input-bordered w-[152px] lg:w-[298px] md:w-[200px]" />
                    </div>
