...
const RoyalCalculetor = () => {
    ...
    return (
        <div>
            <div>
                <div className='px-4 lg:px-8 md:px-7 py-6 lg:py-8 md:py-7  w-full border bg-[#FFFFFF] rounded-xl shadow-[#E7E7FF] shadow-xl mt-8 lg:mt-0 md:mt-0'>
                    ...
                    <div className='grid  grid-cols-2 items-center justify-between  mt-4'>
                        <div> <p className='lg:leading-6 md:leading-6 leading-[21px] md:text-base lg:text-base text-sm font-normal text-[#333333] whitespace-nowrap'>List Price</p></div>
                        <div><input type="number" placeholder="Type here" className="rounded-lg input input-bordered w-full" /></div>
                    </div>
