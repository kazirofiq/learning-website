        ...
        <div>
            <div class="mx-auto max-w-xl">
                ...
                <Link to='/kdptools/bsrcalculetor'>
                    <button className='mt-3 lg:leading-[24px] md:leading-[22px] leading-[21px] text-sm lg:text-base md:text-base rounded-[10px] text-left w-[350px] px-4 py-2 lg:py-3 md:py-3 border inline-block bg-[#F8F8FF] text-[#666666] font-medium  focus:text-white focus:outline-none focus:bg-[#3D419F]'>
