...
const CourseDetailsInput = () => {
  ...
  return (
    <form onSubmit={handleAddWorkshop} className='poppins'>
      <div>
        <label className="label text-[#666666] font-normal text-sm">Workshop Title</label>
        <input name='title' type="text" placeholder="Workshop Title" className="input w-full focus:outline-none bg-[#F8F8FF] focus:border-[1px] focus:border-[#C3C4E1] h-[45px] lg:h-[48px] shadow-none text-[#1B1D48] font-medium text-base placeholder-[#1B1D48]" />
      </div>
      <div className='mt-4'>
        <label className="label text-[#666666] font-normal text-sm">Workshop Subtitle</label>
        <div className="form-control">
          <textarea name='subtitle' className="textarea textarea-bordered h-[104px] w-full focus:outline-none bg-[#F8F8FF] focus:border-[1px] focus:border-[#C3C4E1] shadow-none text-[#1B1D48] font-medium text-base placeholder-[#1B1D48]" placeholder="Workshop Subtitle"></textarea>
        </div>
      </div>
      ...
      <div className='mt-4'>
        <label htmlFor='Workshop-Description' className="label text-[#666666] font-normal text-sm">Workshop Description</label>
        <div className="form-control">
          <textarea name='description' className="textarea textarea-bordered h-[238px] w-full focus:outline-none bg-[#F8F8FF] focus:border-[1px] focus:border-[#C3C4E1] shadow-none text-[#1B1D48] font-medium text-base placeholder-[#1B1D48]" placeholder="Workshop Description"></textarea>
        </div>
      </div>
      <div className='mt-4'>
