        ...
        <section className='h-screen w-screen flex justify-center items-center'>
            <div>
                ...
                <div className=''>
                    ...
                    <p className='text-center mt-4 poppins text-black text-[16px] font-normal'>We've sent an email to <Link target='_blank' className='text-blue-600 font-semibold underline' to="https://mail.google.com/">{user?.email}</Link> to verify your email
                        <br />
