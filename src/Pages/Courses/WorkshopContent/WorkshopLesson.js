...
const WorkshopLesson = ({ title, lessonTitle }) => {
    return (
        <div>
            <div className="collapse collapse-arrow ">
                ...
                <div className="cursor-pointer collapse-content w-[320px] lg:w-[350px] peer-checked:bg-[#F8F8FF] text-primary-content peer-checked:text-[#666666] peer-checked:border-solid peer-checked:border-[#3D419F] peer-checked:border-2 peer-checked:border-t-0 rounded-b-[10px]">
                    {lessonTitle}
