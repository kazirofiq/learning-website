...
const Dashboard = () => {
  ...
  return (
    <div className=''>
      <div>
        <div className='lg:flex hidden items-center content-center justify-between w-[732px] pt-[29px]'>
          <div className=''>
        ...
        <div className='block lg:hidden items-center content-center justify-between w-[320px] lg:w-[732px] mx-5 lg:mx-0'>
          ...
          <div className='flex items-center mt-8 gap-x-[56px] lg:gap-x-[76px]'>
            ...
            {/* <label htmlFor="review-modal" className='flex items-center gap-x-2 bg-[#3D419F] h-[40px] w-[178px] px-4 py-2 text-white font-medium rounded-lg'>
              <img className='h-5 w-5' src={pen} alt='' />
              <button  >Write a Review</button>
            </label> */}
          </div>
